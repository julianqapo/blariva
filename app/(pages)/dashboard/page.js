          ...
          <div className="flex gap-4">
            ...
            <div className="max-w-[85%] space-y-4">
              ...
              <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-white/[0.04] rounded-2xl rounded-tl-sm p-6 shadow-md text-sm leading-relaxed">
                PII must be deleted within{" "}
                <span className="text-amber-600 font-bold">30 days</span> of
                account closure. Transaction records must be kept for 5 years.
              </div>
        ...
        <div className="p-4 bg-slate-50/80 dark:bg-slate-900/80 border-t border-slate-200 dark:border-white/[0.04]">
          <div className="relative">
            <textarea
              ...
              className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-white/10 rounded-xl py-3.5 pl-4 pr-14 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/50 resize-none"
            />
            <button className="absolute right-2 bottom-2 w-9 h-9 rounded-lg bg-amber-500 text-white flex items-center justify-center">
              <Send size={16} />
            </button>
          </div>
        </div>
